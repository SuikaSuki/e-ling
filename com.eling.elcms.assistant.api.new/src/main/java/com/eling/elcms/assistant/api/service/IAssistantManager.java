...
public interface IAssistantManager {
	 ...
	 */
	//IAssistantEventHandler getAssistantElcmsSender();
	 ...
	 * @return
	 */
	List<Coordinate> getAlarmInfo(String imei, Date start, Date end);
	 ...
	 * @return
	 */
	boolean setSMSForward(String imei,List<String> sourcePhone,List<String> targetPhone);
