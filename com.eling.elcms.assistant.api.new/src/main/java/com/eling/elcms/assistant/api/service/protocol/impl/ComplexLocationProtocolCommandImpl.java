...
public class ComplexLocationProtocolCommandImpl implements IProtocolCommand{
	
	@Override
	public String getProtocol() {
		return "IWAP02";
	}
	private static final Logger logger = LoggerFactory.getLogger(ComplexLocationProtocolCommandImpl.class);
