 ...
 */
define("eling/component/ui/daterange/1.0.0/dist/daterange-debug", [ "bootstrap/bootstrap-plugins/daterangepicker/daterangepicker", "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "eling/component/utils/tools/tools", "./daterange.tpl", "./daterange.css" ], function(require, exports, module) {
    ...
    var Daterange_1_0_0 = UIComponent.extend({
        ...
        afterRender: function() {
            ...
            if (!model.title) {
                //设置初始值
                if (model.isinput) {
                    $el.find(".J-daterange").val(model.startDate.format("YYYY.MM.DD") + "-" + model.endDate.format("YYYY.MM.DD"));
                } else {
                    if (model.startDate.format("YYYY.MM.DD") == model.endDate.format("YYYY.MM.DD")) {
                        this.$(".J-daterange span").html(model.startDate.format("YYYY.MM.DD"));
                    } else {
                        this.$(".J-daterange span").html(model.startDate.format("YYYY.MM.DD") + "-" + model.endDate.format("YYYY.MM.DD"));
                    }
                }
            }
            if (model.readonly) {
