 ...
 */
define("eling/component/ui/editgrid/2.0.0/dist/editgrid-debug", [ "eling/component/ui/grid/2.0.0/dist/grid", "jquery/jquery-plugins/pagination/pagination", "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "gallery/handlebars/2.0.0/handlebars-seajs", "eling/component/utils/tools/tools", "eling/component/utils/ajaxwrapper", "dialog", "store" ], function(require, exports, module) {
    ...
    var EditGrid = Grid.extend({
        ...
        _geneTextParams: function(column, widget) {
            ...
            addParams.events = {
                change: function(e) {
                    if (tools.isFunction(column.editor.onAdd)) {
                        var ret = column.editor.onAdd(widget.get("editors"));
                        if (ret !== false) {
