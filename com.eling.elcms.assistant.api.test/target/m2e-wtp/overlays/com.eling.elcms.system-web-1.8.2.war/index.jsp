...
<html>
	<head>
		<title>壹零后养老云平台</title>
		<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
		<meta content='text/html;charset=utf-8' http-equiv='content-type'>
		<meta content='壹零后养老云平台' name='description'>
		...
		<link type="text/css" rel="stylesheet" href="assets/flatty/theme-colors.css">
	
	</head>
	
	<body id="body" class="J-bgColor">
