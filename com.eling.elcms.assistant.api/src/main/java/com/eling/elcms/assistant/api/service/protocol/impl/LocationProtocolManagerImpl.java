...
@Service("assistantLocation")
public class LocationProtocolManagerImpl extends ProtocolManagerImpl{
	
	private static final Logger logger = LoggerFactory.getLogger(LocationProtocolManagerImpl.class);
