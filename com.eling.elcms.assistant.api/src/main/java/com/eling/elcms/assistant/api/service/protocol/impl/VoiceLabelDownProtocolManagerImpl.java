 ...
 *
 */
@Service("assistantVocieLabelDown")
public class VoiceLabelDownProtocolManagerImpl extends ProtocolManagerImpl {
	...
	public String process(String para, String imei) {
		...
		if (nowNum != totalNum || transportFlag == 0) {
			...
			if (transportFlag == 0) {
				...
				saveResult = Contants.VOICE_LABEL_DOWN + "," + senderName + "," + appendMessage + "," + totalNum + ","
						+ nowNum + "," + packegSize + ",.....";
