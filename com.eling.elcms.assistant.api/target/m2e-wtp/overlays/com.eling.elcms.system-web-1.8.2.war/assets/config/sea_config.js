var version = "${app.js.parentdir}";
var ctx = localStorage.getItem("ctx");

//设置缓存参数
localStorage.setItem("home","${app.build.finalName}");
localStorage.setItem("theme","${app.theme}");
localStorage.setItem("city","${app.city}");
...
seajs.config({
	alias : {
		...
		"theme" : "eling/component/theme/src/1.0.0/theme",
		...
		"subnav-2.0.0" : "eling/component/ui/subnav/2.0.0/dist/subnav{mode}",
