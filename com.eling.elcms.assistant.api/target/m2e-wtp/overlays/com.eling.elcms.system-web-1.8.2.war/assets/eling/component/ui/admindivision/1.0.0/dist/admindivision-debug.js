define("eling/component/ui/admindivision/1.0.0/dist/admindivision-debug", [ "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "./admindivision.tpl", "./admindivision.css" ], function(require, exports, module) {
    ...
    var Admindivision_1_0_0 = UIComponent.extend({
        ...
        events: {
            ...
            "click .J-admindivision-province-item": function(e) {
                ...
                //根据所选省加载市
                this.getCities(this.curProvince.code);
                //执行自定义回掉
            ...
            "click .J-admindivision-city-item": function(e) {
                //设置当前所选市
                this.curCity = cities[this.curProvince.code][$(e.currentTarget).attr("data-index")];
                //根据所选省加载市
                this.getPlaces(this.curCity.code);
                //执行自定义回掉
                var model = this.get("model");
                if (typeof model.itemSelected === "function") {
            ...
            "click .J-admindivision-place-item": function(e) {
                //设置当前所选县
                this.curPlace = places[this.curCity.code][$(e.currentTarget).attr("data-index")];
                //执行自定义回掉
                var model = this.get("model");
                if (typeof model.itemSelected === "function") {
