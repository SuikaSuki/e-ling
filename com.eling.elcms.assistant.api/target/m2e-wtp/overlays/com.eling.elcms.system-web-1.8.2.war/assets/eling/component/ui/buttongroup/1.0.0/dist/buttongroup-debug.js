 ...
 * @dependencies []
 */
define("eling/component/ui/buttongroup/1.0.0/dist/buttongroup-debug", [ "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "eling/component/utils/tools/tools", "./buttongroup.tpl", "./buttongroup.css" ], function(require, exports, module) {
...
define("eling/component/ui/buttongroup/1.0.0/dist/buttongroup.tpl", [], '<div id="{{this.id}}" class="el-buttongroup-1">\n	<div class="btn-group">\n		{{#if this.main}}\n			<button class="btn J-buttongroup main {{this.className}}" data-key="{{this.main.key}}"\n				style="background: {{this.theme.bgColor}};">{{this.main.text}}</button>\n			<button class="btn dropdown-toggle {{this.className}}" style="background: {{this.theme.bgColor}};" data-toggle="dropdown">\n				<span class="caret"></span>\n			</button>\n			<ul class="dropdown-menu">\n				{{#each this.sub}}\n					<li><a class="J-buttongroup sub" data-key="{{this.key}}" href="javascript:void(0);">{{this.text}}</a></li>\n				{{/each}}\n			</ul>\n			{{#if this.tip}}\n			<div class="tip">{{this.tip}}</div>\n			{{/if}}\n		{{/if}}\n	</div>\n</div>');
