 ...
 * @dependencies []
 */
define("eling/component/ui/date/1.0.0/dist/date-debug", [ "jquery/jquery-plugins/datetimepicker/jquery.datetimepicker", "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "eling/component/utils/tools/tools", "./date.tpl" ], function(require, exports, module) {
    ...
    var Date_1_0_0 = UIComponent.extend({
        ...
        initCustAttr: function() {
            ...
            if (model.triggerType == "button") {
                ...
                model.innerStyle = "color:white;background:" + model.theme.bgColor + ";";
