define("eling/component/ui/form/2.0.0/dist/form-debug", [ "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "gallery/handlebars/2.0.0/handlebars-seajs", "./formutils", "jquery/jquery-plugins/validate/jquery.validate", "./formvalidate", "./form.css", "./plugins/date", "jquery/jquery-plugins/datetimepicker/jquery.datetimepicker", "./plugins/date.tpl", "./plugins/place", "jquery/jquery-plugins/select2/select2", "eling/component/utils/ajaxwrapper", "dialog", "store", "./plugins/place1", "./plugins/place1.tpl", "eling/component/ui/admindivision/1.0.0/dist/admindivision", "./plugins/select", "./plugins/select.tpl", "./plugins/text", "./plugins/text.tpl", "./plugins/textarea", "./plugins/textarea.tpl", "./plugins/checkradio", "./plugins/checkradio.tpl", "./plugins/autocomplete", "jquery/jquery-plugins/autocomplete/autocomplete", "./form.tpl" ], function(require, exports, module) {
...
define("eling/component/ui/form/2.0.0/dist/plugins/place1", [ "eling/component/ui/form/2.0.0/dist/formutils", "gallery/handlebars/2.0.0/handlebars-seajs", "eling/component/utils/ajaxwrapper", "dialog", "store", "eling/component/ui/admindivision/1.0.0/dist/admindivision", "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap" ], function(require, exports, module) {
    var utils = require("eling/component/ui/form/2.0.0/dist/formutils");
