 ...
 */
define("eling/component/ui/place/1.0.0/dist/place-debug", [ "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "eling/component/utils/tools/tools", "eling/component/ui/admindivision/1.0.0/dist/admindivision", "./place.tpl" ], function(require, exports, module) {
    ...
    var Place_1_0_0 = UIComponent.extend({
        ...
        initCustAttr: function() {
            ...
            if (model.triggerType == "button") {
                model.innerClassName = "btn";
                model.innerStyle = "width:100%;color:white;background:" + model.theme.bgColor + ";";
                model.value = "省/市/区（县）";
