define("eling/component/ui/subnav/1.0.0/dist/subnav-debug", [ "eling/component/core/uicomponent/2.0.0/src/uicomponent", "base", "tools", "handlebars", "theme", "templatable", "bootstrap", "eling/component/utils/ajaxwrapper", "dialog", "store", "gallery/handlebars/2.0.0/handlebars-seajs", "./subnav.css", "gallery/store/1.3.14/store-seajs", "json", "./plugins/button", "eling/component/utils/fullscreen/fullscreen", "./plugins/buttongroup", "./plugins/buttongroup.tpl", "./plugins/buttongroup_member.tpl", "./plugins/time", "bootstrap/bootstrap-plugins/daterangepicker/daterangepicker", "./plugins/search", "./plugins/date", "jquery/jquery-plugins/datetimepicker/jquery.datetimepicker", "./subnav.tpl" ], function(require, exports, module) {
...
define("eling/component/ui/subnav/1.0.0/dist/plugins/button", [ "eling/component/utils/fullscreen/fullscreen", "gallery/store/1.3.14/store-seajs", "json" ], function(require, exports, module) {
    ...
    var Button = {
        getTemplate: function(item) {
            return "<input class='btn J-btn-" + item.id + "' style='color:white;background:" + item.theme + "' value='" + item.text + "' type='button'>";
        },
    ...
    var Buttongroup = {
        getTemplate: function(item) {
            ...
            if (item.items.length != 0) {
                ...
                ret += "<button class='btn J-btngroup-" + item.id + " J-main-" + item.id + "' data-key='" + mainKey + "' style='color:white;background: " + item.theme + ";'>" + mainText + "</button>";
                ret += "<button class='btn J-btngroup-dropdown-" + item.id + " dropdown-toggle' data-toggle='dropdown' style='color:white;background: " + item.theme + ";'>";
...
define("eling/component/ui/subnav/1.0.0/dist/plugins/buttongroup.tpl", [], '{{#if this.main}}\n	<button class="btn J-btngroup-{{this.id}} J-main-{{this.id}}" data-key="{{this.main.key}}" style="color:white;background: {{../this.bgColor}};">{{this.main.text}}</button>\n	<button class="btn J-btngroup-dropdown-{{this.id}} dropdown-toggle" data-toggle="dropdown" style="color:white;background: {{../this.bgColor}};">\n		<span class="caret" style="border-top-color: white;"></span>\n	</button>\n	<ul class="dropdown-menu">\n		{{#each this.sub}}\n			<li><a class="J-btngroup-{{../this.id}}" data-key="{{this.key}}" href="javascript:void(0);">{{this.text}}</a></li>\n		{{/each}}\n	</ul>\n	{{#if this.tip}}\n	<div class="tip">{{this.tip}}</div>\n	{{/if}}\n{{/if}}\n');

define("eling/component/ui/subnav/1.0.0/dist/plugins/buttongroup_member.tpl", [], '{{#if this.items}}\n<button class="btn J-btngroup-defaultMembers J-main-defaultMembers" data-key="{{this.main.key}}" style="color:white;background: {{this.bgColor}};">{{this.main.text}}</button>\n<button class="btn J-btngroup-dropdown-defaultMembers dropdown-toggle" data-toggle="dropdown" style="color:white;background: {{this.bgColor}};">\n	<span class="caret" style="border-top-color: white;"></span>\n</button>\n<ul class="dropdown-menu" style="overflow: auto;max-height: 310px;">\n	{{#each this.sub}}\n		<li>\n			<a class="J-btngroup-defaultMembers" data-key="{{this.key}}" href="javascript:void(0);">{{this.text}}</a>\n		</li>\n	{{/each}}\n</ul>\n<div class="tip">{{this.tip}}</div>\n{{/if}}\n');
...
define("eling/component/ui/subnav/1.0.0/dist/plugins/time", [ "bootstrap/bootstrap-plugins/daterangepicker/daterangepicker" ], function(require, exports, module) {
    require("bootstrap/bootstrap-plugins/daterangepicker/daterangepicker.css");
    require("bootstrap/bootstrap-plugins/daterangepicker/daterangepicker");
    var Time = {
        getTemplate: function(item) {
            var ret = "";
            ret += "<a class='btn btn-white dropdown-toggle J-daterange' href='javascript:void(0);' style='color:white;background: " + item.theme + ";'>";
            ret += "<span>请选择时间</span>";
            ret += "<b class='caret'></b>";
            ret += "</a>";
            if (item.tip) {
...
define("eling/component/ui/subnav/1.0.0/dist/plugins/date", [ "jquery/jquery-plugins/datetimepicker/jquery.datetimepicker" ], function(require, exports, module) {
    require("jquery/jquery-plugins/datetimepicker/jquery.datetimepicker.css");
    ...
    var SubnavDate = {
        ...
        getTemplate: function(param) {
            ...
            return "<input class='btn J-subnav-date-" + param.id + "' style='color:white;background:" + param.theme + "' value='" + defaultDate + "' type='button'>";
        },
        initPlugins: function(item, model) {
            var params = {
                format: "Y-m-d",
