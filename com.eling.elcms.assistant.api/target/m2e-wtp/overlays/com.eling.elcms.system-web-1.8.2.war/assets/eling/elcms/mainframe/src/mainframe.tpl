	...
	<header id="header">
		<nav class="el-headerbar navbar navbar-default">
			<a href="javascript:void(0);" class="J-headerbar-logo navbar-brand">
				<img width="{{this.logo_width}}" height="{{this.logo_height}}" src="{{this.logo_left}}" class="logo"/>
				<img width="21" height="21" src="{{this.logo_left_xs}}" class="logo-xs"/>
			</a> 
			...
			<ul class="nav">
				...
				<li class="dropdown dark user-menu J-username" >
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="http://doc.e-lingcloud.com/elcms" target="_blank"><i class="icon-question-sign"></i>帮助</a></li>
